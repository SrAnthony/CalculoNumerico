...
class FunctionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create function" do
    assert_difference('Function.count') do
      post functions_url, params: { function: { expression: @function.expression, point_a: @function.point_a, point_b: @function.point_b } }
    end
  ...
  test "should update function" do
    patch function_url(@function), params: { function: { expression: @function.expression, point_a: @function.point_a, point_b: @function.point_b } }
